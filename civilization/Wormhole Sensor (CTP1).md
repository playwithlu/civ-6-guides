# Wormhole Sensor (CTP1)
 ...
 | reqtech=Wormholes
 | cost=20000
 | effect=Exposes the {{LinkCTP1|Wormhole}} to all civilizations when completed.
 | obsolete=
The Wormhole Sensor is a wonder in "". It allows the Alien Life project to be constructed.
Gameplay.
The Wormhole Sensor allows the Civilization to find the {{LinkCTP1|Wormhole}}. With a {{LinkCTP1|Wormhole Probe}}, humans can investigate the origins of the alien race. Foreign Civilizations can find the Wormhole's location after the creation of this Wonder. 
Great Library entry.

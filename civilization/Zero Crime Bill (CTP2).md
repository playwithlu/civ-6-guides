# Zero Crime Bill (CTP2)
 ...
 | reqtech=Criminal Code
 | cost=8600
 | effect=-60% {{LinkCTP2|Crime}} in host empire.
 | obsolete=
...
Gameplay.
By re-examining the criminal code, the Zero Crime Bill decriminalizes a range of petty crimes, bringing with it a dramatic reduction in nationwide {{LinkCTP2|Crime}}. The criminal justice system, from police to courts, becomes free of the burden of minor crimes and can concentrate on crimes that are more nefarious. It also reduces the criminal population and recidivism.
Great Library entry.
